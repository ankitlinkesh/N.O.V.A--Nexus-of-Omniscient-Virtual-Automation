...
OPEN_SOURCE_RESOURCES = [
    ...
    _resource(id="eva-roadmap-foundations", name="Eva Roadmap Foundations", category="roadmap", provider="Eva", kind="local_runtime", local_only=True, default_enabled=True, risk_level="low", status="allowed", notes="Phase 33-42 report/status/catalog metadata resource. No new execution path is enabled; Phase 12L remains the only real write boundary."),
